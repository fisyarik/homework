...
* Инициализация репозитория (git init) - процесс создания служебных файлов Git в папке проекта
* Скрытые папки (скрытые файлы) - служебные директории Git, начинающиеся с точки (.git)
* Состояние репозитория (git status) - информация о текущих изменениях, готовых к коммиту
* Настройки авторства (git config)- конфигурация имени и email пользователя для фиксации в коммитах
...
* Хостинг IT-проектов - веб-сервис для размещения и совместной разработки репозиториев
...
* Синхронизация репозиториев - процесс обмена изменениями между локальным и удалённым репозиториями
...
* Бесплатный аккаунт GitHub - учётная запись с базовыми функциями для публичных репозиториев
* Платные возможности GitHub - дополнительные функции вроде приватных репозиториев
...
* Список удалённых репозиториев - перечень всех подключённых внешних источников
...
* git remote - показать список подключённых удалённых репозиториев
* git remote add \[имя] \[путь] - добавить удалённый репозиторий
* git remote -v - показать подробный список удалённых репозиториев с адресами
